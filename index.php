        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="navbar-brand app2-name" href="index2.html"><img src="img/logo.png" class="img-responsive" id="logo" alt=""><strong>Stormly</strong></a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="col-md-6">
      <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
        <div class="col p-4 d-flex flex-column position-static" style="background-color:rgb(211, 206, 206);">
          ...
          <a href="https://www.nrdc.org/experts/anjali-jaiswal/return-delhi-smog-even-more-life-threatening-covid" class="stretched-link">Continue reading</a>
        </div>
    ...
    <div class="col-md-6">
      <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
        <div class="col p-4 d-flex flex-column position-static" style="background-color:rgb(211, 206, 206);">
          ...
          <a href="https://timesofindia.indiatimes.com/city/chennai/tamil-nadu-cm-announces-rs-1116-97-crore-relief-to-11-43-lakh-farmers-affected-by-crop-damage/articleshow/80635857.cms" class="stretched-link">Continue reading</a>
        </div>
        <div class="col-auto d-none d-lg-block">
    ...
    <div class="col-md-6">
      <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
        <div class="col p-4 d-flex flex-column position-static" style="background-color:rgb(211, 206, 206)";>
          ...
          <a href="https://www.ndtv.com/india-news/north-india-shivers-as-srinagar-records-lowest-temperature-in-8-years-2352120" class="stretched-link">Continue reading</a>
        </div>
        <div class="col-auto d-none d-lg-block">
    ...
    <div class="col-md-6">
      <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
        <div class="col p-4 d-flex flex-column position-static" style="background-color:rgb(211, 206, 206)";>
          ...
          <a href="https://theconversation.com/thunderstorms-create-radioactivity-scientists-discover-87946" class="stretched-link">Continue reading</a>
        </div>
        <div class="col-auto d-none d-lg-block">
